...
<div class="container">
	...
	function rezerwacjaGokarta($id_uzytkownika, $godzina, $gokart, $data, $ilosc){
		...
		$zap = $db->prepare("INSERT INTO `rezerwacje` (`id_uzytkownika`, `data`, `gokart`, `potwierdzenie`, `ilosc`) VALUES (:id_uzytkownika, :data, :gokart, 0, :ilosc)");
	...
	if (!empty($_POST['ok'])) {
		...
		echo "<p class='alert-success'>Pomyślnie dodano rezerwacje do rozpatrzenia!</p>";
	}
	else 
	{
		echo '
