	...
	<nav class="navbar navbar-inverse navbar-toggleable-md bg-inverse">
		...
		<div class="collapse navbar-collapse" id="rozwin">
			...
			<ul class="navbar-nav mr-auto">
				<li class="nav-item">
					<a class="nav-link" href="?page=pm">Panel Moderatora</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="?page=rezerwacja">Rezerwacja</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="?page=akceptacja">Rezerwacje do akceptacji</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="?page=rejestracja">Dodaj użytkownika</a>
				</li>
				<li class="nav-item">
